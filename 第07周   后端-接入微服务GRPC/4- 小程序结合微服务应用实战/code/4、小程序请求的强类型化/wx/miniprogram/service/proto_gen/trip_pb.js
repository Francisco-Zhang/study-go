...
export const coolcar = $root.coolcar = (() => {
    ...
    coolcar.Trip = (function() {
         ...
         * @property {boolean|null} [hasDurationSec] Trip hasDurationSec
         */
        ...
        /**
         * Trip hasDurationSec.
         * @member {boolean} hasDurationSec
         * @memberof coolcar.Trip
         * @instance
         */
        Trip.prototype.hasDurationSec = false;
        ...
        Trip.fromObject = function fromObject(object) {
            ...
            if (object.hasDurationSec != null)
                message.hasDurationSec = Boolean(object.hasDurationSec);
            return message;
        };
        ...
        Trip.toObject = function toObject(message, options) {
            ...
            if (message.hasDurationSec != null && message.hasOwnProperty("hasDurationSec"))
                object.hasDurationSec = message.hasDurationSec;
            return object;
        };
